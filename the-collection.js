...
fetch("Collection.json")
  ...
  .then((collection) => {
    collection.forEach((element) => {
      ...
      ul.appendChild(li2);
      ul.appendChild(li3);
      let newDevs = document.createTextNode(
        "Development: " + collection[i].devs
      );
      let newEditors = document.createTextNode(
        "Edited by: " + collection[i].editors
      );
      let newSupport = document.createTextNode(
